...
if armor.materials.bronze then
	...
	armor:register_armor("shields:shield_bronze", {
		...
		groups = {armor_shield=1, armor_heal=6, armor_use=800,
			physics_speed=-0.03, physics_gravity=0.03},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
		reciprocate_damage = true,
...
if armor.materials.mithril then
	...
	armor:register_armor("shields:shield_mithril", {
		...
		groups = {armor_shield=1, armor_heal=8, armor_use=50, armor_feather=1},
		armor_groups = {fleshy=13},
...
if armor.materials.crystal then
	...
	armor:register_armor("shields:shield_crystal", {
		...
		groups = {armor_shield=1, armor_heal=6, armor_use=300, armor_water=1},
...
if armor.materials.nether then
	...
	armor:register_armor("shields:shield_nether", {
		...
		groups = {armor_shield=1, armor_heal=6, armor_use=200, armor_fire=5},
		armor_groups = {fleshy=14, radiation=100},
		damage_groups = {cracky=2, snappy=1, level=3},
		reciprocate_damage = true,
		on_damage = function(player, index, stack)
			play_sound_effect(player, "default_glass_footstep")
