...
setting("int", "size_limit", 35, "Digtron size limit in nodes per moving digtron")
...
setting("float", "cycle_time", 3.0, "Minimum Digtron cycle time")
...
setting("float", "dig_cost_default", 4.0, "Default dig cost")
-- eg, stone
setting("float", "dig_cost_cracky", 3.0, "Cracky dig cost")
-- eg, dirt, sand
setting("float", "dig_cost_crumbly", 1.0, "Crumbly dig cost")
-- eg, wood
setting("float", "dig_cost_choppy", 2.0, "Choppy dig cost")
